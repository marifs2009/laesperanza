    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <a href="{{route('tourcategory.add')}}" class="btn btn-primary d-none d-sm-inline-block">
                                ...
                                @foreach($tour_categories as $category)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a type="submit" class="btn" href="{{ route('tourcategory.edit', ['tourcategory_id' => $category->tour_category_id]) }}">
                                            ...
                                            <form method="POST" action="{{ route('tourcategory.delete') }}" id="form-tour-delete-{{$category->tour_category_id}}">
                                                @csrf
