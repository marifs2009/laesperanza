        ...
        <form id="add_tour_category" name="add_tour_category" class="outer-repeater float-none" method="POST" enctype="multipart/form-data" action="{{route('tourcategory.store')}}">
          ...
          <div class="card-body p-4">
            <div class="row">
              <div class="col-lg-6">
                <div class="mb-3">
                  <label for="tour_code" class="form-label">Code <span class="required">*</span></label>
                  <input class="form-control" id="tour_code" name="tour_code" type="text" placeholder="Enter Title" value=""/>
                  @error('tour_code')
              ...
              <div class="col-lg-6">
                <div class="mb-3"> 
                  ...
                  <select class="form-select" name="tour_type" id="tour_type">
                    <option value="-1">No Parent</option>
                    @if(!empty($tour_parent_categories))
                      @foreach ($tour_parent_category_ids as $tour_type) 
              ...
              <div class="col-lg-6">
                <div class="mb-3">
                  <label for="tour_category_title" class="form-label">Start Location <span class="required">*</span></label>
                  <input class="form-control" id="tour_category_title" name="tour_category_title" type="text" placeholder="Enter Title" value=""/>
                  @error('tour_category_title')
                    <span class="error_msg">{{ $message }}</span>
                  @enderror
              ...
              <div class="col-lg-6">
                <div class="mb-3">
                  ...
                  <input class="form-control" id="tour_type" name="tour_type" type="text" placeholder="Enter Title" value=""/>
                  @error('tour_category_title')
                    <span class="error_msg">{{ $message }}</span>
                  @enderror
                </div>                                           
              ...
              <div class="col-lg-6">
                <div class="mb-2">
                  <label for="tour_excerpt" class="form-label">Excerpt (Optional)</label>
              ...
              <div class="col-lg-6">
                <div class="mb-2">
                  ...
                  <textarea rows="3" class="form-control" id="tour_category_excerpt" name="tour_category_excerpt" placeholder="Excerpt"></textarea>
...
<script>
$('#content').summernote({placeholder: '', tabsize: 2, height: 200});
$('#tour_excerpt').summernote({placeholder: '', tabsize: 2, height: 200});
$('#tour_description').summernote({placeholder: '', tabsize: 2, height: 200});
$('#tour_inclusion').summernote({placeholder: '', tabsize: 2, height: 200});
$('#tour_exclusion').summernote({placeholder: '', tabsize: 2, height: 200});
$('#tour_available_offer').summernote({placeholder: '', tabsize: 2, height: 200});
$('#tour_meals').summernote({placeholder: '', tabsize: 2, height: 200});
$('#tour_transfer').summernote({placeholder: '', tabsize: 2, height: 200});
$('#tour_tax').summernote({placeholder: '', tabsize: 2, height: 200});
</script>
<script>
